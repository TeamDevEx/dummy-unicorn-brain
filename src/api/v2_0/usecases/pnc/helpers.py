...
from api.v2_0.usecases.pnc.prompt import CONDENSE_QUESTION_PROMPT as PNC_CONDENSE_QUESTION_PROMPT
from api.v2_0.usecases.pnc.prompt import CHAT_PROMPT as PNC_CHAT_PROMPT
