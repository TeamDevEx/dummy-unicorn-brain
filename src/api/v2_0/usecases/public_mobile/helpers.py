...
from api.v2_0.usecases.public_mobile.prompt import CONDENSE_QUESTION_PROMPT as PM_CONDENSE_QUESTION_PROMPT
from api.v2_0.usecases.public_mobile.prompt import CHAT_PROMPT as PM_CHAT_PROMPT
