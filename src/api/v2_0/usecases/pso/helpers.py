...
from api.v2_0.usecases.pso.prompt import CONDENSE_QUESTION_PROMPT as PSO_CONDENSE_QUESTION_PROMPT
from api.v2_0.usecases.pso.prompt import CHAT_PROMPT as PSO_CHAT_PROMPT
