...
from api.v2_0.usecases.onesource.prompt import CONDENSE_QUESTION_PROMPT as ONESOURCE_CONDENSE_QUESTION_PROMPT
from api.v2_0.usecases.onesource.prompt import chat_prompt as ONESOURCE_CHAT_PROMPT 
