...
from api.v2_0.llm.ask.utility import log_to_bq
...
async def handle_upload_request(
    ...
    if gcs is None:
        raise HTTPException(status_code=500, detail="GCS Bucket not initialized. Ensure user has access to GCS bucket - line 85 in api.v2_0.py")
