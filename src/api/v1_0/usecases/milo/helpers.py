...
from api.v1_0.usecases.milo.prompt import CONDENSE_QUESTION_PROMPT as MILO_CONDENSE_QUESTION_PROMPT
from api.v1_0.usecases.milo.prompt import CHAT_PROMPT as MILO_CHAT_PROMPT
