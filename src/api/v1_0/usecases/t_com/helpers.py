...
from api.v1_0.usecases.t_com.prompt import CONDENSE_QUESTION_PROMPT as TCOM_SUPPORT_CONDENSE_QUESTION_PROMPT
from api.v1_0.usecases.t_com.prompt import QA_PROMPT as TCOM_SUPPORT_QA_PROMPT
