...
from api.v1_0.usecases.onesource import helpers as onesource_api_helpers
from api.v1_0.usecases.summary import helpers as summary_api_helpers
from api.v1_0.usecases.base.models import QABotBaseQuery, QABotBaseQueryFlexible, RawChatQuery
from api.v1_0.usecases.spoc.models import SpocBotQuery
from api.v1_0.usecases.milo.models import MiloBotQuery
...
from api.v1_0.usecases.standards.models import StandardsBotQuery
from api.v1_0.usecases.t_com.models import TcomBotQuery
from api.v1_0.usecases.spoc.helpers import handle_spoc_request
from api.v1_0.usecases.milo.helpers import handle_milo_request
from api.v1_0.usecases.pnc.helpers import handle_pnc_request
from api.v1_0.usecases.public_mobile.helpers import handle_public_mobile_request
from api.v1_0.usecases.pso.helpers import handle_pso_request
from api.v1_0.usecases.generic.helpers import handle_generic_request
from api.v1_0.usecases.standards.helpers import handle_standards_request
from api.v1_0.usecases.t_com.helpers import handle_tcom_support_request
from api.v1_0.usecases.base.helpers import handle_default_bot_request, handle_raw_bot_request, get_default_embedding_func
from api.v1_0.usecases.logs_summary.helpers import handle_summarize_unanswered_questions_request
from api.v1_0.usecases.logs_summary.models import LogsSummaryBotQuery
from api.v1_0.usecases.base.utility import custom_json_dumps, send_response_from_generate_func, num_tokens_from_messages, get_token_usage
from api.v1_0.search.models import SearchQuery
from api.v1_0.search.helpers import handle_search_request
from api.v1_0.usecases.summary.helpers import handle_Summary_Request, handle_knowledge_assist_request
from api.v1_0.helpers import generator_from_callback
...
import logging
from api.v1_0.usecases.upload_to_db import helpers as upload_to_db_helpers
...
@router.post("/logs/unanswered_questions", tags=["V1.0"])
...
@router.post("/bots/raw", tags=["V1.0"])
def process_raw_bot_request(queryObject: RawChatQuery):
    generate_response_with_callback = handle_raw_bot_request(
        queryObject=queryObject,
    )
    return send_response_from_generate_func(queryObject, generate_response_with_callback)

@router.post("/bots/generic", tags=["V1.0"])
...
@router.post("/bots/spoc", tags=["V1.0"])
...
@router.post("/bots/milo", tags=["V1.0"])
...
@router.post("/bots/public_mobile", tags=["V1.0"])
...
@router.post("/bots/pnc", tags=["V1.0"])
...
@router.post("/bots/pso", tags=["V1.0"])
...
@router.post("/bots/onesource", tags=["V1.0"])
...
@router.post("/bots/onesourcetbs", tags=["V1.0"])
...
@router.post("/bots/tcom_support", tags=["V1.0"])
...
@router.post("/milvus/upload_to_db", tags=["V1.0"])
async def upload_to_db(
    ...
    resp = await upload_to_db_helpers.handle_upload_request( 
                                                        milvus_helper=db["milvus_helper"], 
                                                        embedding_func=default_embedding_func,
                                                        gcs=gcs['gcs'],
                                                        file=file, 
...
@router.get("/milvus/collection", tags=["V1.0"])
def get_collections(db: dict = Depends(get_db_dict)):
    return db["milvus_helper"].list_collections("")


@router.get("/milvus/selfserve_get_loaded_files", tags=["V1.0"])
...
@router.post("/summarize", tags=["V1.0"])
...
@router.post("/knowledge_assist", tags=["V1.0"])
